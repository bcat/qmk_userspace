...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_DEFAULT] = LAYOUT_65(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,  CC_LFN,   KC_SPC,                       KC_SPC,   XXXXXXX,  KC_RALT,  CC_RFN,   KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
    ...
    [LAYER_ADJUST] = LAYOUT_65(
        ...
        _______,  _______,  KC_MPLY,  KC_VOLU,  KC_MSTP,  _______,  EE_CLR,   QK_BOOT,  _______,  _______,  _______,  _______,  _______,  _______,            RGB_SAI,
