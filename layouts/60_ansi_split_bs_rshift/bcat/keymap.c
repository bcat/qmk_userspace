...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_DEFAULT] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_LCTL,  TL_LOWR,  KC_LALT,                                KC_SPC,                                           KC_RALT,  KC_RGUI,  KC_APP,   KC_RCTL
    ),
    [LAYER_LOWER ... LAYER_RAISE] = LAYOUT_60_ansi_split_bs_rshift(
    ...
    [LAYER_ADJUST] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        _______,  _______,  _______,  _______,  _______,  BL_BRTG,  EE_CLR,   QK_BOOT,  _______,  _______,  _______,  UG_VALU,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  BL_UP,    _______,  UG_SPDU,  UG_HUEU,  UG_SATU,  UG_PREV,  UG_NEXT,            UG_TOGG,
        _______,  _______,  _______,  _______,  _______,  BL_DOWN,  _______,  UG_SPDD,  UG_HUED,  UG_SATD,  UG_VALD,  _______,                      _______,
        _______,  _______,  _______,                                _______,                                          _______,  _______,  _______,  _______
    ),
    // clang-format on
};
