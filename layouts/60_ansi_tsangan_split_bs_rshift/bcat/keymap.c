...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_DEFAULT] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
        ...
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,                      CC_RFN,
        KC_LCTL,  CC_LFN,   KC_LALT,                                KC_SPC,                                           KC_RALT,  KC_RGUI,            KC_RCTL
    ),
    [LAYER_FUNCTION] = LAYOUT_60_ansi_tsangan_split_bs_rshift(
