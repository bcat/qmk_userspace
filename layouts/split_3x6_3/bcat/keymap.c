...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_ADJUST] = LAYOUT_split_3x6_3(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,                      UG_PREV,  UG_VALD,  UG_VALU,  UG_NEXT,  UG_SPDU,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,                      UG_HUEU,  UG_SATD,  UG_SATU,  UG_HUED,  UG_SPDD,  _______,
                                                _______,  _______,  _______,  UG_TOGG,  _______,  _______
    ),
    // clang-format on
};
