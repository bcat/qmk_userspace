...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_DEFAULT] = LAYOUT_65_ansi_blocker_split_bs(
        ...
        KC_LCTL,  KC_LGUI,  KC_LALT,                      KC_SPC,                                 KC_RALT,  TL_LOWR,                      KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
    [LAYER_LOWER ... LAYER_ADJUST] = LAYOUT_65_ansi_blocker_split_bs(
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_INS,   KC_DEL,   _______,
        KC_CAPS,  _______,  _______,  _______,  _______,  _______,  EE_CLR,   QK_BOOT,  KC_PSCR,  KC_SCRL,  KC_PAUS,  _______,  _______,  _______,            _______,
